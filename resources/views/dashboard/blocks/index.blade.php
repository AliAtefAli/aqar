                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{trans('dashboard.main.Blocks')}}
                            </li>
                        </ol>
                    </div>
                </div>
                                        ...
                                        <div class="card-header">
                                            ...
                                            <div class="heading-elements">
                                                <ul class="list-inline mb-0">
                                                    <li><a href="{{ route('dashboard.blocks.create') }}"
                                                                        ...
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title"
                                                                                    id="exampleModalLabel">{{ trans('dashboard.Block.Delete Block') }}</h5>
                                                                            ...
                                                                            <div class="modal-body custom-addpro">
                                                                                <div class="contact-page">
                                                                                    <form
                                                                                        action="{{ route('dashboard.blocks.destroy', $block) }}"
                                                                                        method="post">
                                                                                        @csrf
                                                                                        @method('DELETE')
                                                                                        <h2>  {{ trans('dashboard.Block.Do you want to delete this Block') }} </h2>
