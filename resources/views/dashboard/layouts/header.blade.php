                        ...
                        <ul class="mega-dropdown-menu dropdown-menu row">
                            <li class="col-md-2">
                                ...
                                <div id="mega-menu-carousel-example">
                                    <div>
                                        <img class="rounded img-fluid mb-1" src="{{ asset('assets/images/slider/slider-2.png') }}"
                  ...
                  <img src="{{ asset('assets/images/portrait/small/avatar-s-19.png') }}" alt="avatar"><i></i></span>
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        ...
                        <span class="avatar avatar-sm avatar-busy rounded-circle">
                          <img src="{{ asset('assets/images/portrait/small/avatar-s-2.png') }}" alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
                                ...
                                <a href="javascript:void(0)">
                                    <div class="media">
                                        <div class="media-left">
                        <span class="avatar avatar-sm avatar-online rounded-circle">
                          <img src="{{ asset('assets/images/portrait/small/avatar-s-3.png') }}" alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
                        ...
                        <span class="avatar avatar-sm avatar-away rounded-circle">
                          <img src="{{ asset('assets/images/portrait/small/avatar-s-6.png') }}" alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
