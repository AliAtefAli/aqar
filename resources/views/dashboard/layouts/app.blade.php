...
<head>
    ...
    <link rel="apple-touch-icon" href="@if(isset($setting['logo'])){{asset('assets/uploads/settings/' . $setting['logo'] )}} @else {{ asset('assets/dashboard/app-assets/images/ico/favicon.ico') }} @endif">
    <link rel="shortcut icon" type="image/x-icon" href="@if(isset($setting['logo'])){{asset('assets/uploads/settings/' . $setting['logo'] )}} @else {{ asset('assets/dashboard/app-assets/images/ico/favicon.ico') }} @endif">
    ...
    @if(lang() == 'ar')
        <!-- BEGIN RTL CSS-->
            ...
            <link rel="stylesheet" type="text/css" href="{{asset('assets/dashboard/app-assets/css-rtl/pages/error.css')}}">
    ...
    @else
        <!-- BEGIN LTR CSS-->
            ...
            <link rel="stylesheet" type="text/css" href="{{asset('assets/dashboard/app-assets/css/pages/error.css')}}">
    ...
    <!-- DataTable css -->
    @if(lang() == 'ar')
        <link rel="stylesheet" type="text/css" href="{{asset('assets/dashboard/app-assets/vendors/css/tables/extensions/datatables.ar.css')}}">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/dashboard/app-assets/vendors/css/tables/datatable/datatables.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/dashboard/app-assets/vendors/css/tables/extensions/buttons.dataTables.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/dashboard/app-assets/vendors/css/tables/datatable/buttons.bootstrap4.min.css')}}">
...
<script src="{{asset('assets/dashboard/app-assets/vendors/js/tables/datatable/dataTables.buttons.min.js')}}"
...
<script src="{{asset('assets/dashboard/app-assets/vendors/js/charts/chart.min.js')}}" type="text/javascript"></script>
<script src="{{asset('assets/dashboard/app-assets/vendors/js/charts/echarts/echarts.js')}}" type="text/javascript"></script>
<script src="{{asset('assets/dashboard/app-assets/vendors/js/charts/echarts/chart/line.js')}}" type="text/javascript"></script>
<script src="{{asset('assets/dashboard/app-assets/vendors/js/charts/echarts/chart/scatter.js')}}" type="text/javascript"></script>
<script src="{{asset('assets/dashboard/app-assets/vendors/js/charts/echarts/chart/k.js')}}" type="text/javascript"></script>
...
<!-- Datatable js -->
<script src="{{asset('assets/dashboard/app-assets/js/scripts/tables/datatables/datatable-advanced.js')}}"
        type="text/javascript"></script>
<script src="{{ asset('assets/dashboard/app-assets/js/scripts/tables/datatables-extensions/datatable-button/datatable-html5.min.js') }}"></script>
<!-- End of Datatable js -->
