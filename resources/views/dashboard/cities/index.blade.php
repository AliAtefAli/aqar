                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{trans('dashboard.main.Cities')}}
                            </li>
                        </ol>
                    </div>
                </div>
                                        ...
                                        <div class="card-header">
                                            ...
                                            <div class="heading-elements">
                                                <ul class="list-inline mb-0">
                                                    <li><a href="{{ route('dashboard.cities.create') }}"
                                                                        ...
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title"
                                                                                    id="exampleModalLabel">{{ trans('dashboard.City.Delete City') }}</h5>
                                                                            ...
                                                                            <div class="modal-body custom-addpro">
                                                                                <div class="contact-page">
                                                                                    <form
                                                                                        action="{{ route('dashboard.cities.destroy', $city) }}"
                                                                                        method="post">
                                                                                        @csrf
                                                                                        @method('DELETE')
                                                                                        <h2>  {{ trans('dashboard.City.Do you want to delete this City') }} </h2>
